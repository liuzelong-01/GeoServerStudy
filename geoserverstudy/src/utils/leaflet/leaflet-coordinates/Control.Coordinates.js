...
L.Control.Coordinates = L.Control.extend({
  ...
  setCoordinates: function (obj) {
    ...
    if (obj.latlng) {
      ...
      address.longitudeText = obj.latlng.lng.toFixed(this.options.precision).toString()
      address.latitudeText = obj.latlng.lat.toFixed(this.options.precision).toString()
    }
    return address
  }
});
